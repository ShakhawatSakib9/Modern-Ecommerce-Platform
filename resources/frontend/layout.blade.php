...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__auth"><a href="{{ url('/admin') }}">Admin</a></div>
    </div>
    <!-- Offcanvas Menu End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__right">
                        <div class="header__right__auth"><a href="{{ url('/admin') }}">Admin</a></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-5">
                    <div class="footer__widget"><h6>Quick links</h6><ul><li><a href="#">About</a></li><li><a href="#">Blogs</a></li><li><a href="#">Contact</a></li><li><a href="#">FAQ</a></li></ul></div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="footer__widget"><h6>Account</h6><ul><li><a href="#">My Account</a></li><li><a href="#">Orders Tracking</a></li><li><a href="#">Checkout</a></li><li><a href="#">Wishlist</a></li></ul></div>
                </div>
