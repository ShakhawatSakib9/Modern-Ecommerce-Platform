...
@section('page_title', 'Edit Blog Category: ' . $blogCategory->name)
@section('breadcrumb')
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white glass border-bottom">
        <h3 class="card-title text-primary font-weight-bold"><i class="fas fa-edit mr-2"></i>Edit Blog Category</h3>
    </div>
