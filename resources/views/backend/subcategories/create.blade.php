...
@section('page_title', 'New Subcategory')
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white glass border-bottom">
        <h3 class="card-title text-primary font-weight-bold"><i class="fas fa-plus-circle mr-2"></i>Create New Subcategory</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                        id="name" name="name" value="{{ old('name') }}" placeholder="e.g. T-Shirts, Headphones" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                        id="description" name="description" rows="4" placeholder="Brief description of this subcategory">{{ old('description') }}</textarea>
